...
if __name__ == '__main__':
    ...
    # select fcn type
    if unet_type   == 'unet': model = UNet(num_classes)
    elif unet_type == 'unet_pp': model = UNet_pp(num_classes)
    ...
    train_log_path  = os.path.join(save_path, f'{unet_type}_{start_epoch:d}_{start_epoch-1+epochs:d}_train.npy')
    val_log_path    = os.path.join(save_path, f'{unet_type}_{start_epoch:d}_{start_epoch-1+epochs:d}_val.npy')
    val_log_dice_path    = os.path.join(save_path, f'{unet_type}_{start_epoch:d}_{start_epoch-1+epochs:d}_val_dice.npy')
    ...
    plot_loss(unet_type, epochs, lr, batch_size, 'loss.jpg', train_log_path, val_log_path, val_log_dice_path)
